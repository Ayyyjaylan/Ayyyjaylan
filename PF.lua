...
Library:SetWatermark('ehub V2 | Private user')

local Window = Library:CreateWindow({
    Title = tostring(cloneref(game:GetService("MarketplaceService")):GetProductInfo(game.PlaceId).Name) .. " |" .. " #Iray script";
    Center = true;
    AutoShow = true;
    TabPadding = 8;
    MenuFadeTime = 0.2
...
gunModsGB:AddToggle("noSread", {
    Text = "No Spread";
    Default = false;
    Tooltip = "enable / disable weapon spread";
...
gunModsGB:AddToggle("noBob", {
    Text = "No Bob";
    Default = false;
    Tooltip = "enable / disable weapon bob";
...
gunModsGB:AddToggle("noSway", {
    Text = "No Sway";
    Default = false;
    Tooltip = "enable / disable weapon sway";
